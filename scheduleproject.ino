...
// ===================== WiFi & NTP =====================
const char *ssid = "tlechonrad";
const char *password = "tlechonrad888";
...
Subject schedule[7][9] = {
    {{"ไม่มีเรียน",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""}},
    {{"ภาษาอังกฤษ","ครูฝรั่ง 4"},{"ภาษาอังกฤษ","ครูภัทรวัณ"},{"ภาษาไทย","ครูวิทยานัน"},{"เคมี","ครูภทรษร"},{"พักกลางวัน",""},{"ชีววิทยา","ครูภัทรธิรา"},{"คณิตศาสตร์","ครูอากร"},{"สังคมศีกษา","ครูลักษณา"},{"ไม่มีเรียน",""}},
    {{"ฟิสิกส์","ครูสุวะนิด"},{"ฟิสิกส์","ครูสุวะนิด"},{"คอมพิวเตอร์","ครูวรนุช"},{"คอมพิวเตอร์","ครูวรนุช"},{"พักกลางวัน",""},{"คณิตศาสตร์","ครูอากร"},{"ภาษาจีน","ครูนภาลักษณ์"},{"พลศึกษา","ครูอธิปัตย์"},{"ไม่มีเรียน",""}},
    {{"แนะแนว","ครูภณิชชา"},{"คณิตศาสตร์","ครูอากร"},{"เคมี","ครูภทรษร"},{"เคมี","ครูภทรษร"},{"พักกลางวัน",""},{"ชุมนุม",""},{"กิจกรรม รด.",""},{"",""},{"",""}},
    ...
    {{"ชีววิทยา","ครูภัทรธิรา"},{"ชีววิทยา","ครูภัทรธิรา"},{"นาฏศิลป์","ครูชญานิศา"},{"ภาษาอังกฤษ","ครูภัทรวัณ"},{"พักกลางวัน",""},{"พระพุทธศาสนา","ครูคณพศ"},{"คณิตศาสตร์","ครูอากร"},{"คณิตศาสตร์","ครูอากร"},{"ไม่มีเรียน",""}},
    {{"ไม่มีเรียน",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""},{"",""}}
};
